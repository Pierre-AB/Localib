...
class SearchBar extends React.Component {
  ...
  displayAddressInput() {
    ...
    if (AddressInput.style.display === "none") {
      ...
      document.querySelector(".searchbar-place-submit").style.minWidth = "90vw";
      document.querySelector(".searchbar-query").style.minWidth = "auto";
    } else {
      AddressInput.style.display = "none";
      ProductInput.style.display = "block";
      MagnifierPicto.style.display = "block";
      document.querySelector(".searchbar-place-submit").style.minWidth = "auto";
      document.querySelector(".searchbar-query").style.minWidth = "70vw";
    }
  }
  ...
  <div>
    ...
    <div className="autocomplete-dropdown-container">
      ...
      <div className="SearchBar searchbar-desktop-position">
            ...
            <div className="searchbar-place-input-wrapper">
              ...
              >
                ...
                <button onClick={this.props.searchAroundMe} className="searchbar-place-around-me-button dl-button" role="button" type="button">
                  <span style={this.state.isMobile ? {display:"block"} : {display:"block"}}>
        ...
        <div className="searchbar-query" style={this.state.isMobile ? {minWidth:"70vw"} : {minWidth:""}} >
          <div>
