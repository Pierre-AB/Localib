...
class SearchBar extends React.Component {
  ...
  // displayAddressInput() {
  //   let AddressInput = document.getElementsByClassName("mobile-address-input");
  ...
  sendAddressToParent = (event, addressValue) => {
    this.props.handleSelect(addressValue);
    event.preventDefault();
  }

  sendHandleSelection = (event) => {
    this.props.handleChange(addressValue);
    event.preventDefault();
  }
  ...
  render() {
    ...
    <div className="autocomplete-root" >
      <input className="form-control" placeholder="My address" {...getInputProps()} />
        ...
        <div className="searchbar-place-submit">
          <div className="searchbar-place">
            <div className="searchbar-place-input-wrapper">
              <div /* onClick={this.displayAddressInput()} */>
              <PlacesAutocomplete
                className="searchbar-input"
                value={this.state.addressValue}
                onChange={addressValue => {this.sendAddressToParent({addressValue})}}
                onSelect={(e) => {this.sendHandleSelection(e)}}
              ...
              >
                ...
                <input className="searchbar-input mobile-address-input" placeholder="My address"/>
        ...
        <div className="searchbar-query">
          <div>
            <div className="search-container">
              ...
              <input className="searchbar-input" placeholder="Search retailer or product" type="search" value={this.props.query} onChange={(e) => this.props.updateQuery(e.target.value)} />
